...
export class LoginComponent {
  ...
  constructor(private _router:Router,private _auth:AuthenticationService,private toast:ToastService,private _userStore:UserStoreService) {
  ...
  initializeForm() {
   this.loginForm = new FormGroup({
      ...
      password: new FormControl(null, [Validators.required,ValidateForm.passwordValidator()])
    });
  }
